...
7. **[kotlin-to-typescript.md](kotlin-to-typescript.md)** — translation reference for Kotlin/Android folks (sealed classes ↔ unions, Compose ↔ React, developer.android.com architecture ↔ TS/React patterns), plus a section on how a TS-native developer would actually approach the same problem.
